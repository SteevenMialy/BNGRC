...
<main class="main">
    ...
    <div class="topbar">
        <div class="topbar__left">
            <div class="topbar__breadcrumb">
                Accueil &rsaquo; <span>Nouveau Stock</span>
            </div>
            <h1 class="topbar__title">Enregistrer un Stock</h1>
        </div>
    </div>
    ...
    <div class="table-section">
        ...
        <div class="table-wrap" style="padding: 32px;">
            <form action="<?= BASE_URL ?>/stock/insert" method="POST" id="besoinForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="qte" class="form-label fw-semibold">Quantité a inserer <span class="text-danger">*</span></label>
                        <input type="number" step="0.01" class="form-control" id="qte" name="qte" placeholder="Ex: 100" required>
                    </div>


                    <div class="col-md-6 mb-4">
                        <label for="daty" class="form-label fw-semibold">Daty <span class="text-danger">*</span></label>
